...
const {
  ...
  getVaccineData,
  uploadFile,
} = require("../service/vaccineData.service");
const {
  tokenVerification,
} = require("../user/helper/helper.token_verification");
...
router.post("/addVaccineData", addVaccineData);
router.get("/getVaccineData", getVaccineData);
//router.post("/uploadFile" , uploadFile);
router.post(
  "/addCovidData",
  [tokenVerification(), validationBody(schemas.vaccineData)],
  addCovidData
);
