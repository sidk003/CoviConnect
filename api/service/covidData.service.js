...
exports.addCovidData = async (req,res) => {
    const { username,fname,lname,age,occupation,doctorName,doctorMobile,doctorRating,treatment,recoveryPeriod,hospital,hospitalAddress,locationPinCode,symptoms,medicinesTaken,comments,locationAddress,locationCity,locationState,base64file } = req.body;
    //const {   } = req.body;
    try{
